...
class EmailCustomer extends EmailContent
{
...
//        ]);
    ...
    private static function _getSubject(){
        $subject = "Inscription sur la plate-forme Storkoo.be";
    ...
    private static function _insertButtons(string $emailContent = "", string $idCode){
        ...
        $object->$operation = Customer::OPE_AUTHENTICATE;
        $object->className = Customer::class;
        ...
        $confirmButton = self::_getHtmlButton("Confirmer", $url);
