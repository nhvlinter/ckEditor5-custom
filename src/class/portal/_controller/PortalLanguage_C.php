...
class PortalLanguage_C extends Db
{
    ...
    public static function _getDefaultLanguage(): string
    {
        ...
        if($sql->select()){
            ...
            if($rowLanguage !== null && $rowLanguage instanceof Language){
                $defaultLanguage = String_Helper::_isStringNotEmpty($rowLanguage->getIdCode()) ? $rowLanguage->getIdCode() : $defaultLanguage;
            }
        }
    ...
    {
        $page = PortalPage_C::_getPageByUri();
