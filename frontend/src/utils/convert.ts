/**
         ...
         */
export function setupCustomClassConversion(viewElementName, modelElementName, editor) {
...
/**
         ...
         */
export function upcastCustomClasses(elementName) {
...
/**
         ...
         */
export function downcastCustomClassesToFigure(modelElementName) {
...
/**
         ...
         * This converter expects that the view element is nested in a <figure> element.
         */
export function downcastCustomClassesToChild(viewElementName, modelElementName) {
    return dispatcher => dispatcher.on(`insert:${modelElementName}`, (evt, data, conversionApi) => {
        const modelElement = data.item;
