...
import { CKEditor, CKEditor } from "../models/CKEditor";
...
export class CKEditorStore {
    ...
    @action async save() {
        ...
        this.set_data(this.dataChanges);
        this.ckeditor.set_content(this.dataChanges);
        const[err, data] = await CKEditor.save(this.ckeditor);
        this.ckeditor = data;
        return err;
