...
(function ($) {
        ...
        mainMenu: function () {
            if ($mainMenu.length > 0) {
                ...
                var $menuItemLinks = $('#mainMenu nav > ul > li.dropdown > a[href="#"], #mainMenu nav > ul > li.dropdown > .dropdown-arrow, .dropdown-submenu > a[href="#"], .dropdown-submenu > .dropdown-arrow, .dropdown-submenu > span, .page-menu nav > ul > li.dropdown > a' +
                    ', #mainMenu nav > .container-fluid > ul > li.dropdown > a[href="#"]' +
                    ', #mainMenu nav > .container-fluid > ul > li.dropdown > .dropdown-arrow' +
                    ', .dropdown-submenu > a[href="#"]' +
                    ', .dropdown-submenu > .dropdown-arrow, .dropdown-submenu > span' +
                    ', .page-menu nav > .container-fluid > ul > li.dropdown > a'),
    ...
    INSPIRO.slider = {
        ...
        carouselAjax: function () {
            INSPIRO.slider.carousel($(".carousel-polo"));
        },
    ...
    INSPIRO.elements = {
        functions: function () {
            ...
            INSPIRO.elements.backgroundImage();
            INSPIRO.elements.backgroundPattern();
        ...
        backgroundPattern: function () {
            var $backgroundImage = $("[data-bg-pattern]");

            if ($backgroundImage.length > 0) {
                $backgroundImage.each(function () {
                    var $elem = $(this),
                        elemImageSrc = $elem.attr("data-bg-pattern");
                    $elem.addClass("lazy-bg");
                    $elem.attr("data-bg", elemImageSrc);
                });
        ...
        modal: function () {
            ...
            var $modal = $(".modal"),
                ...
                modalAuto = "modal-auto",
                modalShowClass = "modal-active show",
                ...
                $modal.each(function () {
                    ...
                    if (elem.hasClass(modalShow)) {
                        var timeout = setTimeout(function () {
                            elem.addClass(modalShowClass)
                        }, elemDelay)
                    }
                    if (elem.hasClass(modalAuto)) {
                        var timeout = setTimeout(function () {
                            elem.modal('toggle')
                        }, elemDelay)
                    }
